...
class RecipeOrganizerApp:
    ...
    def view_recipe(self, event=None):
        ...
        if selected_index:
            if self.filtered_category == "All recipes":
                recipe_index = selected_index[0]
            else:
                filtered_recipes = [r for r in recipes if r["category"] == self.filtered_category]
                recipe_index = recipes.index(filtered_recipes[selected_index[0]])
    ...
    def export_recipe(self):
        ...
        if file_path:
            ...
            with open(file_path, "w", encoding="utf-8") as file:
                ...
                file.write(f"Video Link: {recipe['video_link']}\n\n")
...
class AddRecipeWindow:
    def __init__(self, app):
        ...
        add_copy_paste_shortcuts(self.ingredients_text)
        ...
        ttk.Label(self.window, text="Video Link:").grid(row=4, column=0, padx=10, pady=5)
        ...
        add_copy_paste_shortcuts(self.comments_text)
...
class EditRecipeWindow:
    def __init__(self, app, recipe_index):
        ...
        ttk.Label(self.window, text="Video Link (Optional):").grid(row=4, column=0, padx=10, pady=5)
...
class ViewRecipeWindow:
    def __init__(self, app, recipe_index):
        ...
        ttk.Label(self.scrollable_frame, text="Video Link:").grid(row=3, column=0, padx=10, pady=5, sticky="e")
    ...
    def export_recipe(self):
        ...
        if file_path:
            with open(file_path, "w", encoding="utf-8") as file:
                ...
                file.write(f"Video Link: {self.recipe['video_link']}\n\n")
